...
import { Search, Zap, ShoppingBag, ShoppingCart, LogOut, Shield, Store, FileText, Package, Crown, X, Settings, Home, Bell, Play, Briefcase } from 'lucide-react';
                    ...
                    {hasValidPlan ? (
                      <>
                        ...
                        >
                          ...
                          <span className="font-bold text-sm">Post Jobs</span>
                        </Link>
                      </>
                    ) : null}
                <Link
