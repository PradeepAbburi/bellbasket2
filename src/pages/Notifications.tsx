...
const NotificationsPage = () => {
    const { notifications, markAllNotificationsRead, user } = useApp();
                    ...
                    <div className="space-y-3">
                        {notifications.length === 0 ? (
                            <div className="glass rounded-[2.5rem] p-12 text-center flex flex-col items-center gap-4">
                                ...
                                <button onClick={() => navigate('/browse')} className="gradient-primary text-white px-6 py-3 rounded-2xl font-bold text-sm shadow-lg shadow-primary/20 mt-2">
                                    Browse Marketplace
                                </button>
                            </div>
                        ) : (
