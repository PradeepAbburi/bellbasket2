...
const Receipts = () => {
  ...
  return (
    <div className="min-h-screen gradient-warm scrollbar-hide">
      <Helmet>
        ...
        <AnimatePresence mode="wait">
          {!selectedOrderId && !selectedBookingId ? (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="space-y-6 pb-40 overflow-y-auto max-h-[85vh] scrollbar-hide"
            >
            ...
            <motion.div
              ...
              exit={{ opacity: 0, x: -20 }}
              className="space-y-6 pb-40 overflow-y-auto max-h-[90vh] scrollbar-hide"
            >
